        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-5 mt-5">
          ...
          <div className="space-y-5">
            ...
            <section className="relative overflow-hidden rounded-3xl border border-fuchsia-500/20 bg-[#090012] min-h-[520px] md:h-[430px]">
              ...
              <Link
                to="/post"
                className="relative z-10 block max-w-2xl px-5 md:px-12 pt-8 group cursor-pointer"
              >
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight text-white group-hover:text-pink-100 transition-colors">
                ...
                <span className="inline-block mt-10 bg-gradient-to-r from-[#ee1978] to-[#ee1978] px-8 py-4 rounded-2xl text-lg font-bold tracking-wide shadow-[0_0_30px_rgba(255,0,170,0.45)] group-hover:scale-[1.02] transition-transform">
                  EXPLORE NEWS
                </span>
              </Link>
